...
*/
function Jar() {
  // our main object is Jar in that cloure class with OOP
  var jar ={}
...
jar.getConcentration = getConcentration;
jar.add = add;
jar.getTotalAmount = getTotalAmount;

  return jar
}
// define methods ouside closure:
var fruits = ["apple","banana", "apricot" , "orange"]
var getConcentration = function(fruits){
	// fruits is an array of fruits as above:
	// whenever jar is empty the concentration = 0;
	if (jar ) {}

};

var add = function(amount){
// this function will add concentrations to our flavor juice
var concentration =0 // init value
